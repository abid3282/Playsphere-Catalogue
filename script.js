...
function showLBCollage(urls) {
  ...
  grid.style.cssText = ['position:absolute','inset:0','display:grid','gap:3px','padding:0',count===5?'grid-template-columns:1.4fr 1fr 1fr;grid-template-rows:1fr 1fr;':'grid-template-columns:repeat('+Math.ceil(count/2)+',1fr);grid-template-rows:1fr 1fr;'].join(';');
