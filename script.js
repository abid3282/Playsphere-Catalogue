...
function showImg(i) {
  ...
  if (isCollage) {
    img.style.display = 'none';
    // Switch image wrap to square ratio for 2x2 grid
    img.parentNode.style.aspectRatio = '1/1';
    // Hide nav arrows and dots — collage is a single unit
    document.getElementById('lbPrev').style.display = 'none';
    document.getElementById('lbNext').style.display = 'none';
    document.getElementById('lbDots').innerHTML = '';
    ...
    // Still render dots and thumbs for navigation context
