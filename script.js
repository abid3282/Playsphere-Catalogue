...
function showImg(i) {
  ...
  if (isCollage) {
    ...
    grid.style.cssText = 'position:absolute;inset:0;display:grid;grid-template-columns:1fr 1fr;gap:4px;padding:4px;background:#000;';
    entry.collage.forEach(function(url) {
      var ci = document.createElement('img');
      ci.src = url;
      ci.style.cssText = 'width:100%;height:100%;object-fit:cover;';
      grid.appendChild(ci);
    });
